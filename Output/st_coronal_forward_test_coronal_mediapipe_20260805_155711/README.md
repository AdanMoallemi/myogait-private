...
**Run Timestamp**: 2026-08-05 15:57:21  
...
| **Overall Symmetry Index (SI)** | `33.6` % | Normal < 10% |
...
- ⚠️ **Asymmetry knee: SI=35.5% (>20%)**
- ⚠️ **Asymmetry ankle: SI=51.9% (>20%)**
- ⚠️ **Asymmetry stance_time: SI=74.5% (>20%)**
...
```text
st_coronal_forward_test_coronal_mediapipe_20260805_155711/
